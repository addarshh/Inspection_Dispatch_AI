...
AMANA_CODE = "003"
MODELS_TO_RUN = ["CP"]
INSPECTION_CATEGORIES = ["GENERAL_CLEANING"]
MODEL_NAME = 'CP_GENERALCLEANING_ENGINE'
OUTPUT_TABLE_NAME='CP_GENERALCLEANING_CASES'
...
SewerManholes_path=os.path.join(working_dir,'data','Sewer Manholes','SewerManholes.shp')
BuildingFootPrint_path=os.path.join(fpath,'buBuildingFootPrintS.csv')
