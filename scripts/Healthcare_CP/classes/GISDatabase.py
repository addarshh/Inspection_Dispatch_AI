...
class GISDatabase(ABC):
    ...
    def getPOPULATION(self):
        ...
        # self.shpGrid = self.shpGrid.rename(columns={'GRIDUNIQUECODE':'GridUniqueCode'})
        # self.shpGrid = self.shpGrid.rename(columns={'GRIDNAME':'GridName','MUNICIPALITY':'MUNICIPALI', 'MUNICIPALITYCODE':'MUNICIPA_1', 'GRID_ID': 'GridNumber' })
