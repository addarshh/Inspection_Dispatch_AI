...
class InspectionRBD(Inspection):
		...
		def _licensesDataModification(self):
			...
			logging.info("shape after dropping duplicates in licenses data is :"+str(self.data.licensesDf.shape))
			logging.info("left join licenses and licenses keys on business activity")
			...
			logging.info("after joining shape is :"+str(self.data.licensesDf.shape))
