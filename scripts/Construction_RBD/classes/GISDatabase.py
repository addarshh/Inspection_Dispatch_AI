...
def get_grid_zone():
    ...
    GridZones = GridZones.loc[GridZones['INSPECTIONTYPE'] == 5]
...
class GISDatabase(ABC):
    ...
    def getPopulationData(self):
        ...
        self.shpGrid=pd.read_csv(config.population_grids_path,dtype={"amanacode":"str","municipalitycode":"str","regioncode":"str"})
        #self.shpGrid.geometry = self.shpGrid.geometry.astype('str')
    ...
    def getPriorityAreasData(self):
        ...
        logging.info("shape of priority areas is :"+str(self.priorityAreas.shape))
    ...
    def getMUNICIPALITY(self):
        ...
        logging.info("shape of municipalities is :"+self.MUNICIPALITY.shape)
    ...
    def getSUBMUNICIPALITY(self):
        ...
        print(self.SUBMUNICIPALITY.shape)
        print(self.priorityAreas.head(3))
        logging.info("shape of sub municipalities is:"+self.SUBMUNICIPALITY.shape)
