...
MODEL_NAME = 'RBD_CONSTRUCTION_ENGINE'
FEATURES_OUTPUT_TABLE_NAME='RBD_CONSTRUCTION_FEATURES'
LICENSES_OUTPUT_TABLE='RBD_CONSTRUCTION_LICENSES'
GRIDS_OUTPUT_TABLE_NAME='RBD_CONSTRUCTION_GRIDS'
...
DB_WIN_DEV = {
    ...
    'port' : 1521,
    'instantclient' : r"../../instantclient-basic-windows.x64-21.6.0.0.0dbru/instantclient_21_6",
    'instantclient' : 'C:\\instantclient_21_6',
    'input_schema': 'C##MOMRAH',
    'outputschema' : 'C##OUTPUTS_MOMRAH',
    'connectiontype' : 'SID',
    'gisuser': 'USER_AELSAADI',
