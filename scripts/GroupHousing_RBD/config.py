...
municipality_path=os.path.join(GISPATH,'MUNICIPALITY.csv')
...
AMANA_CODE = None
MODELS_TO_RUN = ["RBD"]
MODEL_NAME = 'RBD_GROUPHOUSING_ENGINE'
INSPECTION_CATEGORIES = ["GroupHousing"]
FEATURES_OUTPUT_TABLE_NAME='RBD_GROUPHOUSING_FEATURES'
LICENSES_OUTPUT_TABLE='RBD_GROUPHOUSING_LICENSES'
GRIDS_OUTPUT_TABLE_NAME='RBD_GROUPHOUSING_GRIDS'

PATHS = {
    # 'municipality': f'{FEATURE_CREATION_INPUT_FOLDER}/Amana.shp',
    'amana_municipality': f'{FEATURE_CREATION_INPUT_FOLDER}/Municipality/Municipality.shp',
