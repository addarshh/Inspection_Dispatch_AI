...
def Risk_score(df, features_list):
    ...
    visibility_features = ['DN_score', 'no_of_priority_areas_score', 'days_elapsed_score',
                           'landuse_priority_score', 'path_length_sum_score', 'volume_score']
    impact_features = ['Priority_score', 'Customer_score', 'proportion_failed_causes_score',
                       'days_left_to_expiry_score', 'digging_duration_score']
    ...
    df_final=df_final[['caseid', 'geometry', 'latitude', 'longitude', 'priority_value',
              ...
              'landuse_priority', 'digging_duration', 'path_length_sum', 'volume',
              'days_left_to_expiry', 'proportion_failed_causes', 'DN_score', 'no_of_priority_areas_score',
              'days_elapsed_score',
              'landuse_priority_score', 'path_length_sum_score', 'volume_score',
              'Priority_score', 'Customer_score', 'proportion_failed_causes_score',
              'days_left_to_expiry_score', 'digging_duration_score',
